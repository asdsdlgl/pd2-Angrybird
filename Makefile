...
# Template: app
# Command: E:\QT\5.6\mingw49_32\bin\qmake.exe -spec win32-g++ "CONFIG+=debug" "CONFIG+=qml_debug" -o Makefile AngryThing.pro
#############################################################################
...
Makefile: AngryThing.pro E:/QT/5.6/mingw49_32/mkspecs/win32-g++/qmake.conf E:/QT/5.6/mingw49_32/mkspecs/features/spec_pre.prf \
